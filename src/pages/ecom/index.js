        ...
        <main>
            ...
            <div className="grid lg:grid-cols-2 py-4 lg:py-10">
                <div className="lg:w-2/4 mx-auto p-8 lg:p-0">
                    ...
                    <div className="flex-row gap-4 justify-between mt-4 flex-wrap">
                        <img src={product1}
                            onClick={() => setClickImg(product1)}
                            className="w-20 rounded-xl cursor-pointer" alt="" />
                        <img src={product2} onClick={() => setClickImg(product2)} className="w-20 rounded-xl cursor-pointer" alt="" />
                        <img src={product3} onClick={() => setClickImg(product3)} className="w-20 rounded-xl cursor-pointer" alt="" />
                        <img src={product4} onClick={() => setClickImg(product4)} className="w-20 rounded-xl cursor-pointer" alt="" />
                    </div>
                </div>
                ...
                <div className="my-4 px-6 lg:w-3/4 mt-8 lg:mt-0">
                    ...
                    <p className="pt-6 text-lg">These low-profile sneakers are your perfect casula wear companion. featuring a durable rubber outer sole. They will withstand everything the weather can offer .</p>
                    ...
                    <div className="flex justify-between pt-8 items-center">
                        <div className="w-1/2 py-1 flex-row justify-around mr-2 rounded-xl bg-gray-200 shadow-md">
                        ...
                        <button className="w-1/2 rounded-xl py-3 bg-blue-600 text-gray-50 text-xl lg:text-2xl filter shadow-xl">Add to cart</button>
                    </div>
                </div>
            </div>
